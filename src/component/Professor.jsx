...
const journalsAPA = researchData
...
const conferencesAPA = researchData
        ...
        <Grid className={ProfessorStyle['honor']}
          ...
          <List subheader={
            ...
            <ListItem>
              ...
              <ListItemText className={ProfessorStyle['honor-text']}>
              Biographical Listings in Marquis&apos;s Who&apos;s Who in Science
              and Engineering 9th, 10th Anniversary Edition <br />
              2006 ~ 2007, 2007 ~ 2008
              </ListItemText>
            </ListItem>
            <ListItem>
